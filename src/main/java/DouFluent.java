...
public class DouFluent {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
                ...
                .withMessage("User defined timeout")
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/header/ul/li[4]/a"))).click();
        JavascriptExecutor js = (JavascriptExecutor)driver;
        js.executeScript("scroll(0, 500)");

        //click on Стажировки в украинских компаниях button
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[1]/div[4]/div/div[2]/div/div/div[3]/div[1]/ul/li[12]/div/a"))).click();
        JavascriptExecutor js1 = (JavascriptExecutor)driver;
        js1.executeScript("scroll(0, 250)");

        //click on Junior дайджест: курси, стажування, вакансії. Травень’20
        wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("Junior дайджест: курси, стажування, вакансії. Травень’20"))).click();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"container\"]/div[2]/div[1]/div/div[2]/a"))).click();
        driver.quit();
    }
}